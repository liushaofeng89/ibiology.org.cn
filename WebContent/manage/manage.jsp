...
<head>
    ...
    <script src="../resource/Highcharts-4.0.1/highcharts.js"></script>
	<script src="../resource/Highcharts-4.0.1/modules/exporting.js"></script>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> 资料录入统计图</h3>
                            </div>
