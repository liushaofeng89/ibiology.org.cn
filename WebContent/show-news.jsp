...
<head>
    ...
    <title>360°生命物语系统上线 - 360°生命物语</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Date/Time -->
                <p>
                	<i class="fa fa-user"></i> 责任人：admin&nbsp;&nbsp;<i class="fa fa-clock-o"></i> 更新时间：2014-11-10 22:22:39&nbsp;&nbsp;<i class="fa fa-hand-o-up"></i> 点击量：128次
				</p>
                ...
                <!-- Post Content -->
                <p>系统上线时间：2014-11-11 16:15:32</p>
                <p>域名备案成功时间：2014-11-11 10:32:06</p>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"1","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"16"},"share":{},"image":{"viewList":["qzone","tsina","tqq","renren","weixin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            ...
            <div class="col-md-3">
                ...
                <div class="well">
                    <h4>新闻标签</h4>
                    <p>
                    	<span class="label label-info"><i class="fa fa-tag"></i> 域名</span> 
                    	<span class="label label-success"><i class="fa fa-tag"></i> 备案</span>
                    	<span class="label label-success"><i class="fa fa-primary"></i> 360°生命物语</span>
                    </p>
                </div>
